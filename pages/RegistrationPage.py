...
class RegistrationPageHelper(BasePage):
    ...
    @allure.step('Выбор рандомной страны из списка и проверка соответствующего кода страны в поле "Номер телефона"')
    ...
    @allure.step('Проверка кода страны для поля "Номер телефона" ')
