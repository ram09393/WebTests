...
class BasePageLocators:
    ...
    MORE_BUTTON_VK = (By.XPATH, '//*[@data-l="t,more"]')
...
class BasePageHelper:
    ...
    def click_more_button_vk(self):
        self.find_element(BasePageLocators.MORE_BUTTON_VK).click()

    @allure.step('Переходим на страницу VK/Проекты')
    def get_windows_id(self, index):
        return self.driver.window_handles[index]

    @allure.step('Возврат на главную страницу https://ok.ru/')
    def switch_window_id(self, window_id):
